...
public class TreeFiltering {
	public static void main(String[] args) throws Exception {
		...
		JPanel content = new JPanel(new MigLayout("fill"));
		...
		content.add(search, "w 100%, wrap");
		
		content.add(new JScrollPane(tree), "w 100%, h 100%, wmin 300, hmin 400");
	...
	private static class Renderer extends DefaultTreeCellRenderer {
		...
		@Override public void paint(Graphics g) {
			...
			if (matchOffset > -1) {
				...
				System.out.println("matchpart : "+matchPart);
